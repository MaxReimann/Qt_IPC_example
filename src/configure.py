...
# system.
build_file = "../autogen/datastreamer.sbf"
...
command = " ".join([config.sip_bin, "-c", "../autogen", "-b", build_file, "-I", config.pyqt_sip_dir,  pyqt_sip_flags, "datastreamer.sip"])
os.system(command)
# print(command)
...
installs.append(["datastreamer.sip", os.path.join("../build", "datastreamer")])
...
# makefile.extra_libs = ["datastreamer"]
